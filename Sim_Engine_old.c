...
//         if (eventptr->evtype == FROM_LAYER5) { //                       GENERATE PACKET
//             if (nsim < nsimmax) {
//                 if (nsim + 1 < nsimmax)
...
//                     B_output(msg2give);
//             }
//         } else if (eventptr->evtype == FROM_LAYER3) { //                RECEIVE PACKET
...
//         } else if (eventptr->evtype == TIMER_INTERRUPT) { //             TIMER INTERRUPT
//             if (eventptr->eventity == A)
//                 A_timerinterrupt();
//             else
//                 B_timerinterrupt();
